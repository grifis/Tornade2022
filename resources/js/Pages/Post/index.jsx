                        ...
                        <div className="flex flex-col flex-1 p-4 sm:p-6">
                            <div className="flex justify-between items-end">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <span className="block text-gray-800">{post.user.name}</span>
                            ...
                            <h2 className="text-gray-800 text-lg font-semibold mb-2">
                                <Link href={`/posts/${post.id}`}
                                   className="hover:text-indigo-500 active:text-indigo-600 transition duration-100">{post.title}</Link>
                            </h2>

                            <Link href={`/posts/${post.id}`} className="text-gray-500 mb-4">{post.body.substr(0, 30)}...続きを読む</Link>
                            <div className='flex'>
